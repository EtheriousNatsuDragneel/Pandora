    ...
    children: [
      ...
      },
      {
      ...
      },
       {
         ...
         meta: { title: '成绩列表', noCache: true }
       },
      {
        path: 'teacher/edit',
        component: () => import('@/views/user/teacher/edit'),
        name: 'UserTeacherEdit',
        meta: { title: '成绩查看', noCache: true, activeMenu: '/user/teacher/list' },
        hidden: true
      },
      {
        path: 'teacher/read',
        component: () => import('@/views/user/teacher/read'),
        name: 'UserTeacherRead',
        meta: { title: '试卷批改', noCache: true, activeMenu: '/user/teacher/list' },
        hidden: true
      },
      {
        path: 'admin/list',
    ...
    children: [
      {
        ...
        meta: { title: '类型列表', noCache: true }
      },
      {
        path: 'subject/edit',
        component: () => import('@/views/education/subject/edit'),
        name: 'EducationSubjectEditPage',
        meta: { title: '类型编辑', noCache: true, activeMenu: '/education/subject/list' },
        hidden: true
      }
    ]
  },
