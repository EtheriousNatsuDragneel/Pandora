...
public interface ExamPaperAnswerService extends BaseService<ExamPaperAnswer> {
     ...
     * @return: com.github.pagehelper.PageInfo<com.alvis.exam.domain.ExamPaperAnswer>
     */
    PageInfo<ExamPaperAnswer> studentPage2(ExamPaperAnswerPageVM requestVM);
    /**
     * @param requestVM
     * @Description:
     * @author: LF
     ...
     * @return: com.github.pagehelper.PageInfo<com.alvis.exam.domain.ExamPaperAnswer>
     */
    List<ExamPaperAnswer> studentExcel(ExamPaperAnswerPageVM requestVM);
    /**
     * 计算试卷提交结果(不入库)
     *
    ...
    List<ExamPaperAnswer> studentPage3(Integer id);
}
